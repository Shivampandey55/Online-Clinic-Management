...
$a="select * from lab where username='$username'";
...
?>
	...
	{
	?>
	<th width="200px" align="right" style="font-size:16px;color:#666666;font-family:'Arial Narrow', Arial, Helvetica, sans-serif">Username:</th><th width="300px" align="left"><?php echo "<input type=text name=name disabled=disabled value=" . $row['username'] . ">";?></th>
	</tr>
	<tr>
	...
	<tr><th colspan="2"><form method="post" action="lab.php"><input type="submit" value="Click here to login" /></form></th></tr>
	</table>
	<?php
	}
	?>
