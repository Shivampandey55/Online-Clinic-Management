...
include_once("connect.php");
		  $result=mysqli_query($con,"select *from appointment where id='$id' and password='$password' ")
		  or die(mysqli_error($con));
		  $query=mysqli_query($con,"update appointment set password='$npassword' where id='$id' " )
		  or die(mysqli_error($con));
          ?>
		  </th>
          </tr>
